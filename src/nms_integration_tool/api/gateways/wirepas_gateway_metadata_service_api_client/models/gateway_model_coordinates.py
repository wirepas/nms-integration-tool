...
T = TypeVar("T", bound="GatewayModelCoordinates")


@_attrs_define
class GatewayModelCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gateway_model_coordinates.additional_properties = d
        return gateway_model_coordinates
