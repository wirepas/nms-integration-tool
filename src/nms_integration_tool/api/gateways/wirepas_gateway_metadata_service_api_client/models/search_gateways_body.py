...
T = TypeVar("T", bound="SearchGatewaysBody")


@_attrs_define
class SearchGatewaysBody:
    """
    Attributes:
        query (str): More detailed search query for limiting the request to subset of gateways based on the defined
            filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_gateways_body.additional_properties = d
        return search_gateways_body
