...
T = TypeVar("T", bound="CreateGatewaysBodyItemCoordinates")


@_attrs_define
class CreateGatewaysBodyItemCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_gateways_body_item_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        create_gateways_body_item_coordinates.additional_properties = d
        return create_gateways_body_item_coordinates
