...
T = TypeVar("T", bound="UpdateGatewayBodyCoordinates")


@_attrs_define
class UpdateGatewayBodyCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_gateway_body_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        update_gateway_body_coordinates.additional_properties = d
        return update_gateway_body_coordinates
