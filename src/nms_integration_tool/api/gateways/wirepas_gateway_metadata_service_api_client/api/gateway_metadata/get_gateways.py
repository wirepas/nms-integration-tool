...
from ...models.get_gateways_order import GetGatewaysOrder
from ...models.get_gateways_response_200 import GetGatewaysResponse200
...
def _get_kwargs(
    *,
    ...
    order: GetGatewaysOrder | Unset = GetGatewaysOrder.ASC,
...
) -> ErrorResponse | GetGatewaysResponse200 | str:
    if response.status_code == 200:
        response_200 = GetGatewaysResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GetGatewaysResponse200 | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get a list of gateways
     ...
     Returns list of managed gateway devices. In general, client shall sort and page the results
    accordingly
    ...
    Args:
        ...
        cursor (str | Unset):
        query (str | Unset):
        order (GetGatewaysOrder | Unset):  Default: GetGatewaysOrder.ASC.
...
def sync(
    *,
    ...
    total_results_count_only: bool | Unset = UNSET,
    sort_by: str | Unset = "name",
) -> ErrorResponse | GetGatewaysResponse200 | str | None:
    """Get a list of gateways
