...
T = TypeVar("T", bound="CreateNetworksBodyItem")


@_attrs_define
class CreateNetworksBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_networks_body_item.additional_properties = d
        return create_networks_body_item
