...
T = TypeVar("T", bound="SearchNetworksBody")


@_attrs_define
class SearchNetworksBody:
    """
    Attributes:
        query (str): More detailed search query for limiting the request to subset of networks based on the defined
            filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_networks_body.additional_properties = d
        return search_networks_body
