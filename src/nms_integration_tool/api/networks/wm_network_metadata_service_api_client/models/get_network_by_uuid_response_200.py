...
T = TypeVar("T", bound="GetNetworkByUuidResponse200")


@_attrs_define
class GetNetworkByUuidResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_network_by_uuid_response_200 = cls(
            uuid=uuid,
        ...
        get_network_by_uuid_response_200.additional_properties = d
        return get_network_by_uuid_response_200
