...
T = TypeVar("T", bound="CreateLocationsBodyItemApproxCoordinates")


@_attrs_define
class CreateLocationsBodyItemApproxCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_locations_body_item_approx_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        create_locations_body_item_approx_coordinates.additional_properties = d
        return create_locations_body_item_approx_coordinates
