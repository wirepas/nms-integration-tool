...
T = TypeVar("T", bound="SearchLocationsBody")


@_attrs_define
class SearchLocationsBody:
    """
    Attributes:
        query (str): More detailed search query for limiting the request to subset of locations based on the defined
            filters.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_locations_body.additional_properties = d
        return search_locations_body
