...
T = TypeVar("T", bound="UpdateLocationBodyApproxCoordinates")


@_attrs_define
class UpdateLocationBodyApproxCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_location_body_approx_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        update_location_body_approx_coordinates.additional_properties = d
        return update_location_body_approx_coordinates
