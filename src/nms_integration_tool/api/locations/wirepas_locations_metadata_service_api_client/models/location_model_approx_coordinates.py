...
T = TypeVar("T", bound="LocationModelApproxCoordinates")


@_attrs_define
class LocationModelApproxCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_model_approx_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        location_model_approx_coordinates.additional_properties = d
        return location_model_approx_coordinates
