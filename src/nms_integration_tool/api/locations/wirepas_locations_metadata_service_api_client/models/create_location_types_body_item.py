...
T = TypeVar("T", bound="CreateLocationTypesBodyItem")


@_attrs_define
class CreateLocationTypesBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_location_types_body_item = cls(
            name=name,
        ...
        create_location_types_body_item.additional_properties = d
        return create_location_types_body_item
