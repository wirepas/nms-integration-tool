...
def sync_detailed(
    ...
    *,
    ...
    """Partially/patch update the location object

     Update the given fields in a specific location object identified by UUID.

    **NOTE:** The item given in the body may not be a complete location object, thus only those fields
