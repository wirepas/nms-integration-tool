...
from ...models.search_locations_body import SearchLocationsBody
from ...models.search_locations_response_200 import SearchLocationsResponse200
from ...types import Response


def _get_kwargs(
    *,
    body: SearchLocationsBody,
) -> dict[str, Any]:
...
) -> ErrorResponse | SearchLocationsResponse200 | str:
    if response.status_code == 200:
        response_200 = SearchLocationsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SearchLocationsResponse200 | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r"""Advanced search of location objects

     Search for location objects with complex query parameters and conditions. The filtering and search
    ...
    can use \"str(string)\" to ensure it
    is treated as a string e.g. name>=\"str(123)\". Nested fields can be accessed with a dot operator
    e.g. `approxCoordinates.latitude`.

    The query rules shall use the property field names of the Location resource/object.
...
def sync(
    *,
    client: AuthenticatedClient,
    body: SearchLocationsBody,
) -> ErrorResponse | SearchLocationsResponse200 | str | None:
    r"""Advanced search of location objects
