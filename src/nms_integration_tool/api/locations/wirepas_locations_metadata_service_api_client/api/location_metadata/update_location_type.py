...
from ...models.update_location_type_body import UpdateLocationTypeBody
...
def sync_detailed(
    ...
    *,
    ...
    """Update the location type object

     Update a specific location type identified by UUID with a provided object (complete object)
