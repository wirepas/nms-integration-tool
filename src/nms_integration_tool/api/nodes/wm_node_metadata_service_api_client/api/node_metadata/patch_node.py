...
def sync_detailed(
    ...
    *,
    ...
    """Partially/patch update the node

     Update the given fields in a specific node identified by UUID.

    **NOTE:** The item given in the body may not be a complete node object, thus only those fields that
