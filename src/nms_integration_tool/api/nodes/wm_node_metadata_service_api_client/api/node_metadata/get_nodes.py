...
from ...models.get_nodes_order import GetNodesOrder
...
def _get_kwargs(
    *,
    ...
    order: GetNodesOrder | Unset = GetNodesOrder.ASC,
...
) -> ErrorResponse | GetNodesResponse200 | str:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GetNodesResponse200 | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get a list of nodes
     ...
     Returns list of managed Wirepas nodes. In general, client shall sort and page the results
    accordingly to
    avoid excess load on the service and communications media.
    ...
    Args:
        ...
        cursor (str | Unset):
        query (str | Unset):
        order (GetNodesOrder | Unset):  Default: GetNodesOrder.ASC.
...
def sync(
    *,
    ...
    total_results_count_only: bool | Unset = UNSET,
    sort_by: str | Unset = "name",
) -> ErrorResponse | GetNodesResponse200 | str | None:
    """Get a list of nodes
