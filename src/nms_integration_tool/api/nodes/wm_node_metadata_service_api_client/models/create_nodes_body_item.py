...
T = TypeVar("T", bound="CreateNodesBodyItem")


@_attrs_define
class CreateNodesBodyItem:
    """
    Attributes:
        network_uuid (UUID): A reference to the network resource this node is related to
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_nodes_body_item.additional_properties = d
        return create_nodes_body_item
