...
T = TypeVar("T", bound="ResponsePagingInformation")
...
class ResponsePagingInformation:
    ...
    Attributes:
        ...
        total_results_count (int | Unset): Total number of items matching the given query. This field is only available
            in the response
            when totalResultsCountOnly=true is given as a query parameter. Cursor values are not returned
            in the response.
    """
    ...
    total_results_count: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if total_results_count is not UNSET:
            field_dict["totalResultsCount"] = total_results_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        total_results_count = d.pop("totalResultsCount", UNSET)

        response_paging_information = cls(
        ...
        response_paging_information.additional_properties = d
        return response_paging_information
