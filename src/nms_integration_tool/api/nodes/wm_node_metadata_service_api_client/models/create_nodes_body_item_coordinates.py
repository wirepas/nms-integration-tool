...
T = TypeVar("T", bound="CreateNodesBodyItemCoordinates")


@_attrs_define
class CreateNodesBodyItemCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_nodes_body_item_coordinates = cls(
            latitude=latitude,
            longitude=longitude,
            altitude=altitude,
            epsg=epsg,
        ...
        create_nodes_body_item_coordinates.additional_properties = d
        return create_nodes_body_item_coordinates
