...
T = TypeVar("T", bound="NodeModelCoordinates")


@_attrs_define
class NodeModelCoordinates:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        node_model_coordinates.additional_properties = d
        return node_model_coordinates
